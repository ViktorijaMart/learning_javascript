...
const male = data.filter((elem) => elem.gender === "Male").length;
console.log(male);

// Sukurkite masyvą, kuriuose būtų id visų žmonių, kurie turi automobilius naujesnius nei 2000 metai.

const newCar = data.filter((elem) => elem.car_year > 2000);
console.log(newCar);
...
const size = data
  .filter((elem) => elem.shirt_size === "XS" || elem.shirt_size === "S")
